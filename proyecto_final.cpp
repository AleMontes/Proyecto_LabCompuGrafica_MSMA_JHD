...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecto_Final_MontesManuel_JimenezDiana", nullptr, nullptr);
	...
	Model awa((char*)"Models/lake.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-0.20f, 0.0f,-1.49f));
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.70f, 0.0f, -1.49f));
		model = glm::scale(model, glm::vec3(0.2f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		tree.Draw(lightingShader);
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.6f, 0.01f, -3.5f));
		model = glm::scale(model, glm::vec3(0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		awa.Draw(lightingShader);
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.1f, 0.01f, -3.5f));
		model = glm::scale(model, glm::vec3(0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		awa.Draw(lightingShader);
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.6f, 0.01f, -3.5f));
		model = glm::scale(model, glm::vec3(0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		awa.Draw(lightingShader);
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.7f, 0.01f, -3.5f));
		model = glm::scale(model, glm::vec3(0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		awa.Draw(lightingShader);
		...
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.5f, 0.01f, 0.8f));
